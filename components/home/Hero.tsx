...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Bekhzod.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I enjoy <span className="heroShiny1 text-fun-pink">building</span>{" "}
          high <span className="heroShiny2 text-fun-pink">quality</span> web
          apps.
          <img
          ...
          />
          <img
            className="sqD bottom-[-300px] -right-1/4 sm:right-[-30%] lg:bottom-[-300px] lg:right-[-20px] w-[100px]"
